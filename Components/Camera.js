      ...
      <View style={{flex: 1}}>
        <Camera style={{flex: 1, justifyContent: 'space-between'}} type={this.state.type}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 10, marginBottom: 15, alignItems: 'flex-end'}}>
            <MaterialCommunityIcons name='message-reply' style={{color:'white', fontSize: 36}}></MaterialCommunityIcons>

            <View style={{alignItems:'center'}}>
              <MaterialCommunityIcons name='circle-outline' style={{color:'white', fontSize: 100}}></MaterialCommunityIcons>
              <Icon name='ios-images' style={{color:'white', fontSize: 36}} />
            </View>
            <MaterialCommunityIcons name='google-circles-communities' style={{color:'white', fontSize: 36}}></MaterialCommunityIcons>
          </View>
        </Camera>
      </View>)
    }
